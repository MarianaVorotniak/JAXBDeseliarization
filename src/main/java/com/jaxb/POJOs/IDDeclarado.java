...
@Data
@XmlType(name = "IDDeclarado")
@XmlAccessorType(XmlAccessType.FIELD)
public class IDDeclarado {

    @Size (max = 1)
    @XmlElement(name = "Clave", namespace="https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ddii/enol/ws/DeclaracionInformativa.xsd")
    private String key;
